...
def search_and_self_ask(user_input):
    with open(r'C:\Users\RodrigoPintoMesquita\Documents\GitHub\DR4_AT\data\input_embedding.json', 'r', encoding='utf-8') as file:
        texto = json.load(file)
        
    model_name = 'neuralmind/bert-base-portuguese-cased'
    llm_model_dir = 'C:/Users/RodrigoPintoMesquita/Documents/GitHub/DR4_AT/data/bertimbau_'
